...
define(["require", "exports", "../view", "lib/di"], function (require, exports, view_1, di_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AppDispatcher = /** @class */ (function () {
        function AppDispatcher(viewManager) {
            this.viewManager = viewManager;
        }
        AppDispatcher.prototype.invoke = function () {
            this.viewManager.loadView();
        };
        AppDispatcher = __decorate([
